...
bool Football::checkPlaneCollision(GameObject plane)
{
	...
	for (int i = 0; i < 3; i++) // check each axis using AABB
	{
...
void Football::draw() // draws quadric sphere, sets rotation and translation according to the objects transform
{
	...
	// create and textures the football
